...
> **Important:** Always install from a [release ZIP](https://github.com/exelearning/mod_exeweb/releases). Do not clone the repository directly, as it does not include the embedded editor which is built during the release process.
