 ...
 *
 * @covers \mod_exeweb\local\embedded_editor_installer
 */
class embedded_editor_installer_test extends \advanced_testcase {
    ...
    public function test_validate_zip_valid(): void {
        $tmpdir = make_temp_directory('mod_exeweb_test');
    ...
    public function test_normalize_extraction_flat(): void {
        $tmpdir = make_temp_directory('mod_exeweb_test/flat_extract');
    ...
    public function test_normalize_extraction_single_nested(): void {
        $tmpdir = make_temp_directory('mod_exeweb_test/nested_extract');
    ...
    public function test_normalize_extraction_double_nested(): void {
        $tmpdir = make_temp_directory('mod_exeweb_test/double_nested');
    ...
    public function test_normalize_extraction_no_index(): void {
        $tmpdir = make_temp_directory('mod_exeweb_test/no_index_extract');
    ...
    public function test_validate_editor_contents_valid(): void {
        $tmpdir = make_temp_directory('mod_exeweb_test/valid_contents');
        file_put_contents($tmpdir . '/index.html', '<!DOCTYPE html>');
        mkdir($tmpdir . '/app', 0777, true);
    ...
    public function test_validate_editor_contents_invalid(): void {
        $tmpdir = make_temp_directory('mod_exeweb_test/invalid_contents');
    ...
    public function test_store_metadata(): void {
        ...
        $this->assertEquals('4.0.0', get_config('exeweb', 'embedded_editor_version'));
        $this->assertNotEmpty(get_config('exeweb', 'embedded_editor_installed_at'));
    }
    ...
    public function test_clear_metadata(): void {
        ...
        set_config('embedded_editor_version', '4.0.0', 'exeweb');
        set_config('embedded_editor_installed_at', '2025-01-15 10:30:00', 'exeweb');

        $installer = new embedded_editor_installer();
        $installer->clear_metadata();

        $this->assertFalse(get_config('exeweb', 'embedded_editor_version'));
        $this->assertFalse(get_config('exeweb', 'embedded_editor_installed_at'));
    }
    ...
    public function test_safe_install(): void {
        ...
        $sourcedir = make_temp_directory('mod_exeweb_test/install_source');
    ...
    public function test_safe_install_replaces_existing(): void {
        ...
        // Create new source.
        $sourcedir = make_temp_directory('mod_exeweb_test/replace_source');
    ...
    public function test_concurrent_install_lock(): void {
        ...
        set_config('embedded_editor_installing', time(), 'exeweb');
    ...
    public function test_stale_lock_ignored(): void {
        ...
        set_config('embedded_editor_installing', time() - 600, 'exeweb');
