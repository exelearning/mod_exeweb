 ...
 *
 * @covers \mod_exeweb\external\manage_embedded_editor
 */
class manage_embedded_editor_test extends \advanced_testcase {
    ...
    /**
     * Test that execute_action requires mod/exeweb:manageembeddededitor capability.
     *
    ...
    public function test_execute_action_requires_manageembeddededitor_capability(): void {
        ...
        // Create a user without mod/exeweb:manageembeddededitor.
    ...
    public function test_execute_action_requires_site_config_capability(): void {
        ...
        // Create a user and assign only mod/exeweb:manageembeddededitor (not moodle/site:config).
        $user = $this->getDataGenerator()->create_user();
        $roleid = $this->getDataGenerator()->create_role();
        $systemcontext = \context_system::instance();
        assign_capability('mod/exeweb:manageembeddededitor', CAP_ALLOW, $roleid, $systemcontext->id, true);
    ...
    public function test_get_status_detects_installing_lock(): void {
        ...
        set_config(embedded_editor_installer::CONFIG_INSTALLING, time(), 'exeweb');
    ...
    public function test_get_status_detects_stale_lock(): void {
        ...
        set_config(embedded_editor_installer::CONFIG_INSTALLING, time() - 400, 'exeweb');
