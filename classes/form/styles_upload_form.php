...
/**
 * Style upload form for the mod_exeweb admin page.
 *
 * @package    mod_exeweb
...
class styles_upload_form extends \moodleform {
    ...
    protected function definition() {
        ...
        $mform->addRule('styles_zip',
            get_string('stylesupload_failed', 'mod_exeweb'), 'required');
        ...
        $this->add_action_buttons(false, get_string('stylesupload_submit', 'mod_exeweb'));
    }
}
