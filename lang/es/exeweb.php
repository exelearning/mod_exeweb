...
$string['teachermodevisible'] = 'Mostrar selector de modo docente';
$string['teachermodevisible_help'] = 'Si se desactiva, se ocultará el selector de modo docente dentro del recurso incrustado.';