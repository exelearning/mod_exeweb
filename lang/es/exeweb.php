...
$string['embeddednotinstalled'] = 'Los archivos del editor integrado no están instalados.';
...
$string['embeddednotinstalledadmin'] = 'Los archivos del editor integrado no están instalados. Puede instalarlo desde la configuración del plugin.';$string['editembedded'] = 'Editar con eXeLearning';
