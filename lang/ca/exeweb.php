...
$string['editorinstallsuccess'] = 'L\'editor eXeLearning v{$a} s\'ha instal·lat correctament.';
$string['editoruninstallsuccess'] = 'S\'ha eliminat la instal·lació de l\'editor incrustat.';
$string['editorversion'] = 'Versió';
$string['editorinstalledat'] = 'Instal·lat el';
$string['editorsource'] = 'Origen';
$string['editoractivesource'] = 'Origen actiu';
...
$string['editorconfirmuninstall'] = 'Segur que voleu eliminar l\'editor instal·lat per administració? S\'utilitzarà la versió inclosa o remota.';
$string['editorupdateavailable'] = 'Actualització disponible: v{$a}';
$string['editorcurrentversion'] = 'Versió actual: v{$a}';
$string['editornotyetinstalled'] = 'No s\'ha trobat cap editor instal·lat per administració.';
...
$string['editormanagelink'] = 'Gestiona l\'editor incrustat';
$string['editorsourceprecedence'] = 'Prioritat d\'origen: instal·lat per administració > inclòs.';
$string['exeweb:manageembeddededitor'] = 'Gestiona la instal·lació de l\'editor incrustat d\'eXeLearning';
$string['editorcheckingerror'] = 'No s\'han pogut comprovar les actualitzacions. És possible que GitHub no estigui disponible temporalment.';
$string['editorinstallconfirm'] = 'Això descarregarà i instal·larà l\'última versió de l\'editor eXeLearning (v{$a}) des de GitHub. Voleu continuar?';
$string['editoradminrequired'] = 'L\'editor incrustat d\'eXeLearning no està instal·lat. Poseu-vos en contacte amb l\'administrador del lloc.';
...
$string['latestversionchecking'] = 'Comprovant...';
$string['latestversionerror'] = 'No s\'han pogut comprovar les actualitzacions';
...
$string['embeddednotinstalled'] = 'Els fitxers de l\'editor integrat no estan instal·lats.';
...
$string['embeddednotinstalledadmin'] = 'Els fitxers de l\'editor integrat no estan instal·lats. Podeu instal·lar-lo des de la configuració del connector.';$string['editembedded'] = 'Editar amb eXeLearning';
