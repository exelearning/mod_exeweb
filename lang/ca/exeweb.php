...
$string['embeddednotinstalledadmin'] = 'Els fitxers de l\'editor integrat no estan instal·lats. Podeu instal·lar-lo des de la <a href="{$a}" target="_top">configuració del connector</a>.';
