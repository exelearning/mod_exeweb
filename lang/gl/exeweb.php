...
$string['embeddednotinstalledadmin'] = 'Os ficheiros do editor integrado non están instalados. Pode instalalo desde a <a href="{$a}" target="_top">configuración do complemento</a>.';
