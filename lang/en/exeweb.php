...
$string['embeddednotinstalledadmin'] = 'The embedded editor files are not installed. You can install it from the plugin settings.';$string['editembedded'] = 'Edit with eXeLearning';
